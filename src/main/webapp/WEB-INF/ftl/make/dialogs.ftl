            ...
            <div class="modal-body">
                <form id="operationForm" class="form-horizontal" action="">
                    <div class="form-group">
                        <label for="keyboardEnable" class="col-sm-5 control-label">快捷键</label>
                        <div class="col-sm-7">
                            <input class="lc_switch lcs_check lcs_tt1" id="keyboardEnable" name="keyboardEnable"
                                   value="1"
                                   checked="checked" autocomplete="off" type="checkbox"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="userGuideEnable" class="col-sm-5 control-label">用户指南</label>
                        <div class="col-sm-7">
                            <input class="lc_switch lcs_check lcs_tt1" id="userGuideEnable" name="userGuideEnable"
                                   value="1"
                ...
                <form id="settingForm" class="form-horizontal" action="">
                        ...
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <select id="sheetType" name="sheetType" class="selectpicker form-control ezasData">
                                    ...
                                    <option value="2" selected="selected" style="border-bottom: 1px solid #ccc;">A4
                                    </option>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <label>
                                    <input type="radio" id="enableAB" name="enableABSheetType"
                                           class="a3Column ezasData css-checkbox uncheck" value="1">
                                    <label class="css-radio-label labelTip" for="enableAB">A/B卷</label>
                                </label>
                                <label>
                                    <input type="radio" id="disableAB" name="enableABSheetType"
                                           class="a3Column css-checkbox ezasData " value="0" checked>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <label>
                                    <input type="radio" id="blackSheet" name="sheetColor"
                                           class="a3Column ezasData css-checkbox uncheck" value="1" checked>
                                    <label class="css-radio-label labelTip" for="blackSheet">黑白卡</label>
                                </label>
                                <label>
                                    <input type="radio" id="redSheet" name="sheetColor"
                                           class="a3Column css-checkbox ezasData " value="2">
                        ...
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <select id="curSubject" name="curSubject" class="selectpicker form-control ezasData">
                                    <!-- <option value="1">语文</option> &ndash;&gt;
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <label>
                                    <input type="radio" id="printSingle" name="printType"
                                           class="a3Column ezasData css-checkbox uncheck" value="1">
                                    <label class="css-radio-label labelTip" for="printSingle">单面</label>
                                </label>
                                <label>
                                    <input type="radio" id="printDouble" name="printType"
                                           class="a3Column css-checkbox ezasData " value="2" checked>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <label>
                                    <input class="copyRight css-checkbox ezasData" id="copyRight" name="copyRight"
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <label>
                                    <input type="radio" id="rectGrid" name="gridType"
                                           class="gridType css-checkbox ezasData" value="1" checked>
                                    <label class="css-radio-label labelTip" for="rectGrid">矩形(<img alt=""
                                                                                                   src="${request.contextPath}/static/css/images/grid_rect.png">)</label>
                                </label>
                                <label>
                                    <input type="radio" id="bracketGrid" name="gridType"
                                           class="gridType css-checkbox ezasData" value="2">
                                    <label class="css-radio-label labelTip" for="bracketGrid">中括号(<img alt=""
                                                                                                       src="${request.contextPath}/static/css/images/grid_bracket.png">)</label>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <label>
                                    <input type="radio" id="omrBigger" name="omrSize"
                                           class="omrSize css-checkbox ezasData" value="1" checked>
                                    <label class="css-radio-label labelTip" for="omrBigger">大号</label>
                                </label>
                                <label>
                                    <input type="radio" id="omrSmaller" name="omrSize"
                                           class="omrSize css-checkbox ezasData" value="2">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <label>
                                    <input class="studentTemplateEnable css-checkbox ezasData"
                                           id="studentTemplateEnable" name="studentTemplateEnable" value="1"
                                           type="checkbox">
                                        ...
                                        <div class="checkbox">
                                            <div class="form-group">
                                                <label class="blockLabel" style="display:inline-block;">
                                                    <input type="radio" class="css-checkbox ezasData" id="userName"
                                                           name="userName" value="userName" checked>
                                                    <label class="css-radio-label labelTip" for="userName">姓名</label>
                                                </label>
                                                <label class="blockLabel"
                                                       style="display:inline-block; padding-left: 10px;">
                                                    <input type="checkbox" class="css-checkbox ezasData" id="clazzName"
                                                           name="clazzName" value="clazzName" checked>
                                                    <label class="css-checkbox-label labelTip"
                                                           for="clazzName">班级</label>
                                                </label>
                                                <label class="blockLabel" style="display:inline-block;">
                                                    <input type="radio" class="css-checkbox ezasData" id="school"
                                                           name="stuInfo" value="school" checked>
                                                    <label class="css-radio-label labelTip" for="school">学校</label>
                                                </label>
                                                <label class="blockLabel"
                                                       style="display:inline-block; padding-left: 10px;">
                                                    <input type="radio" class="css-checkbox ezasData" id="grade"
                                                           name="stuInfo" value="grade">
                                                    <label class="css-radio-label labelTip" for="grade">年级</label>
                                                </label>
                                                <label class="blockLabel" style="display:inline-block;">
                                                    <input type="radio" class="css-checkbox uncheck ezasData"
                                                           id="subjectName" name="stuInfo" value="subjectName">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="checkbox">
                                            <div class="form-group">
                                                <label class="blockLabel">
                                                    <input class="a3Column ezasData css-checkbox uncheck"
                                                           id="sheetAType" name="sheetABType" type="radio" value="1"
                                                           checked>
                                                    <label class="css-radio-label labelTip" for="sheetAType">A</label>
                                                </label>
                                                <label class="blockLabel">
                                                    <input class="a3Column css-checkbox ezasData" id="sheetBType"
                                                           name="sheetABType" type="radio" value="2">
                                    ...
                                    <div class="panel-body">
                                        <div class="checkbox">
                                            <div class="zkzhPanel form-group">
                                                <label class="blockLabel">
                                                    <input type="radio" class='css-checkbox uncheck ezasData' id="qr"
                                                           name="studentCode" value="qr">
                                                    <label class="css-radio-label labelTip" for="qr">二维码区</label>
                                                </label>
                                                <label class="blockLabel">
                                                    <input type="radio" class='css-checkbox uncheck ezasData'
                                                           id="barCode" name="studentCode" value="barCode">
                                                    <label class="css-radio-label labelTip" for="barCode">条形码区</label>
                                                </label>
                                                <label>
                                                    <input type="radio" class="css-checkbox ezasData" id="zkzh"
                                                           name="studentCode" value="zkzh" checked>
                                                    <label class="css-radio-label labelTip" for="zkzh">准考证号</label>
                                                </label>
                                                <label>
                                                    <div class="zkzhCountPanel" style="display:inline-block;">
                                                        <input type="text" class="form-control zkzhCount ezasData"
                                                               style="width:40px;height:25px;display:inline-block;"
                                                               name="zkzhCount" value="6">
                                                        <span>位</span>
                                                    </div>
                                                </label>
                                            </div>
                                ...
                                <div class="panel panel-default fillingArea">
                                    ...
                                    <div class="panel-body">
                                        <div class="checkbox">
                                            <div class="form-group">
                                                <label>
                                                    <input type="checkbox" class="css-checkbox ezasData"
                                                           id="wrongFilling" name="wrongFilling" value="wrongFilling"
                                                           readonly="readonly" checked>
                                                    <label class="css-checkbox-label labelTip"
                                                           for="wrongFilling">正误填涂</label>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default absentBreachArea">
                                    ...
                                    <div class="panel-body">
                                        <div class="checkbox">
                                            <div class="form-group">
                                                <label class="blockLabel">
                                                    <input type="radio" class="css-checkbox ezasData"
                                                           id="absentAndBreach" name="absentAndTag"
                                                           value="absentAndBreach" readonly="readonly" checked>
                                                    <label class="css-radio-label labelTip"
                                                           for="absentAndBreach">缺考违纪</label>
                                                </label>
                                                <label class="blockLabel">
                                                    <input type="radio" class="css-checkbox ezasData" id="tagArea"
                                                           name="absentAndTag" value="tagArea" readonly="readonly">
                                    ...
                                    <div class="panel-body">
                                        <div class="checkbox">
                                            <div class="form-group">
                                                <label>
                                                    <input type="checkbox" class="css-checkbox ezasData"
                                                           id="attentionNote" name="attentionNote" value="attentionNote"
                                                           checked>
                                                    <label class="css-checkbox-label labelTip"
                                                           for="attentionNote">注意事项</label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" style="display:inline-block;">修改注意事项</h4>&emsp;<h6
                    style="display:inline-block;">(使用"|"表示换行符)</h6>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-body">
                <form id="forbiddenForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input class="forbiddenInfo ezasData form-control" id="forbiddenInfo" name="forbiddenInfo"
                                   type="text">
            ...
            <div class="modal-body">
                <form id="itemNumForm" class="form-horizontal" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" id="itemNums" name="itemNums" type="input"
                                   placeholder="连续题号用-分隔，不连续题号用,分隔">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group noMargin">
                        ...
                        <div class="col-sm-8 noRightPadding">
                            <label>
                                <input class="css-checkbox bracketsType ezasData uncheck" id="zgItemParentheses"
                                       name="brackets" value="1" type="radio" checked>
                                <label class="css-radio-label labelTip" for="zgItemParentheses">(1)______</label>
                            </label>&nbsp;&nbsp;
                            <label>
                                <input class="css-checkbox bracketsType ezasData" id="zgItemParenthesesNo"
                                       name="brackets" value="2" type="radio">
                ...
                <div id="fillItemContainer" class="as-nicescroll">
                    <form id="fillItemNumForm" class="form-horizontal" action="">
                        <div class="form-group noMargin">
                            ...
                            <div class="col-sm-8">
                                <input id="fillItemTitle" name="fillItemTitle" type="text" class="form-control"
                                       value="填空题">
                            </div>
                        </div>
                        ...
                        <div class="form-group noMargin">
                            ...
                            <div class="col-sm-8 noRightPadding">
                                <label>
                                    <input class="css-checkbox bracketsType ezasData uncheck" id="parentheses"
                                           name="brackets" value="1" type="radio" checked>
                                    <label class="css-radio-label labelTip" for="parentheses">(1)______</label>
                                </label>&nbsp;&nbsp;
                                <label>
                                    <input class="css-checkbox bracketsType ezasData" id="parenthesesNo" name="brackets"
                                           value="2" type="radio">
                        ...
                        <div class="form-group noMargin">
                            ...
                            <div class="col-sm-3 noRightPadding">
                                <label>
                                    <input class="css-checkbox lineType ezasData uncheck" id="line" name="lineType"
                                           value="1" type="radio" checked>
                                    <label class="css-radio-label labelTip" for="line">实线</label>
                                </label>&nbsp;&nbsp;
                                <label>
                                    <input class="css-checkbox lineType ezasData" id="dottedLine" name="lineType"
                                           value="2" type="radio">
                        ...
                        <div class="form-group fillItemPanel noMargin opts">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control" id="itemNum_count" name="itemNum_count" value="1"
                                       type="text">
                            </div>
            ...
            <div class="modal-body">
                <div id="choiceQuestionContainer" class="form-horizontal as-nicescroll">
                    ...
                    <div class="form-group noMargin">
                        ...
                        <div class="col-sm-10">
                            <select class="selectpicker form-control ezasData orientation" id="orientation"
                                    name="orientation">
                            ...
                            <form class="questionItemForm">
                                ...
                                <div class="form-group noMargin">
                                    <div class="col-sm-6 noPadding">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="selectpicker form-control ezasData groupQuestionNum"
                                                    name="groupQuestionNum">
                                    ...
                                    <div class="col-sm-6 noPadding">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="selectpicker form-control ezasData choiceOption"
                                                    name="choiceOption">
                                ...
                                <div class="form-group noMargin">
                                    <div class="col-sm-6 noPadding">
                                        ...
                                        <div class="col-sm-8">
                                            <label>
                                                <input class="choiceType css-checkbox ezasData" id="typeSingle"
                                                       name="choiceType" value="1" type="radio" checked>
                                                <label class="css-radio-label labelTip" for="typeSingle">单选</label>
                                            </label>
                                            <label>
                                                <input class="choiceType css-checkbox ezasData uncheck" id="typeMulti"
                                                       name="choiceType" value="2" type="radio">
                            ...
                            <div class="form-group common-group">
                                <div class="col-sm-offset-2 col-sm-7">
                                    <label class="col-sm-4 noPadding">
                                        ...
                                        <label class="css-checkbox-label labelTip"
                                               for="enableSmallComposition">小作文</label>
                                    </label>
                    ...
                    <div class="tab-pane fade" id="enComposition">
                        <form id="enCompositionForm" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label>
                                        <input type="radio" class="css-checkbox lineType ezasData uncheck" id="compLine"
                                               name="lineType" value="1" checked>
                                        <label class="css-radio-label labelTip" for="compLine">实线</label>
                                    </label>
                                    <label>
                                        <input type="radio" class="css-checkbox lineType ezasData" id="compDottedLine"
                                               name="lineType" value="2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label>
                                        <input type="radio" class="css-checkbox drawType ezasData" id="drawEnd"
                                               name="drawType" value="1" checked>
                                        <label class="css-radio-label labelTip" for="drawEnd">到题卡末尾</label>
                                    </label>
                                    <label>
                                        <input type="radio" class="css-checkbox drawType ezasData uncheck"
                                               id="drawCustom" name="drawType" value="2">
                ...
                <form id="autoBuildForm" class="form-horizontal" action="">
                    <div class="form-group">
                        <div class="col-sm-offset-1">
                            ...
                            <div class="col-sm-7">
                                <label>
                                    <input type="radio" id="autoBuildA3" name="sheetType"
                                           class="a3Column ezasData css-checkbox" value="1" checked>
                                    <label class="css-radio-label labelTip" for="autoBuildA3">A3</label>
                                </label>
                                <label>
                                    <input type="radio" id="autoBuildA4" name="sheetType"
                                           class="a3Column css-checkbox ezasData " value="2">
            ...
            <div class="modal-body">
                <form id="serialForm" class="form-horizontal" action="">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="serialNum ezasData css-checkbox form-control" type="text" id="serialNum"
                                   name="serialNum" placeholder="生成多个编号以,分隔" value="1">
                        </div>
                    </div>
                    <div class="form-group">
